...
![filter](prof_filter1.png) (время затрачивается на работу программы и ввод данных)
...
![old](prof_filter_old.png) (время затрачивается только на работу программы и неэффективно)
...
![with](prof_filter2.png) (время затрачивается на работу программы, эффективно)
